...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { Description: @purchase_order.Description, ExpiryDate: @purchase_order.ExpiryDate, IssueDate: @purchase_order.IssueDate, Number: @purchase_order.Number, Quantity: @purchase_order.Quantity }
    end
  ...
  test "should update purchase_order" do
    put :update, id: @purchase_order, purchase_order: { Description: @purchase_order.Description, ExpiryDate: @purchase_order.ExpiryDate, IssueDate: @purchase_order.IssueDate, Number: @purchase_order.Number, Quantity: @purchase_order.Quantity }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
